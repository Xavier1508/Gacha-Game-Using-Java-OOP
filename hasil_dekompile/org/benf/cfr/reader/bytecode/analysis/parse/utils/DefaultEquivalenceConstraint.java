...
implements EquivalenceConstraint {
    ...
    public boolean equivalent(Collection col1, Collection col2) {
        ...
        while (i1.hasNext()) {
            Object o1 = i1.next();
            Object o2 = i2.next();
            if (!(o1 instanceof ComparableUnderEC && o2 instanceof ComparableUnderEC ? !this.equivalent((ComparableUnderEC)o1, (ComparableUnderEC)o2) : !this.equivalent(o1, o2))) continue;
            return false;
        }
        return true;
    }
