...
HasByteCodeLoc {
    ...
    public Expression applyReverseExpressionRewriter(ExpressionRewriter var1, SSAIdentifiers var2, StatementContainer var3, ExpressionRewriterFlags var4);
    ...
    public <T> T visit(ExpressionVisitor<T> var1);
