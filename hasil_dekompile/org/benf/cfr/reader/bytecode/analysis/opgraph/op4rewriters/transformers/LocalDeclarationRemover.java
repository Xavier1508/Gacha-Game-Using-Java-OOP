...
public class LocalDeclarationRemover
implements StructuredStatementTransformer,
ExpressionRewriter {
    @Override
    public StructuredStatement transform(StructuredStatement in, StructuredScope scope) {
        if (in instanceof StructuredDefinition && ((StructuredDefinition)in).getLvalue() instanceof SentinelLocalClassLValue) {
    ...
    public Expression rewriteExpression(Expression expression, SSAIdentifiers ssaIdentifiers, StatementContainer statementContainer, ExpressionRewriterFlags flags) {
        ...
        if (tmp instanceof StructuredStatementExpression && (container = ((StructuredStatementExpression)tmp).getContent().getContainer()) != null) {
