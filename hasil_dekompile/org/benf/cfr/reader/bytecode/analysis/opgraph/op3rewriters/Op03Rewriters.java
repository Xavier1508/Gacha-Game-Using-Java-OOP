...
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.AssertionJumps;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.BadCompareRewriter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.BreakRewriter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.ClassifyGotos;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.CondenseConditionals;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.CondenseConstruction;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.ConditionalCondenser;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.ConditionalSimplifier;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.DeadConditionalRemover;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.DupAssigns;
...
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.IsolatedStackValue;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.JoinBlocks;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.JumpsIntoDoRewriter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.JumpsIntoLoopCloneRewriter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.LValueCondense;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.MonitorRewriter;
...
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.PrePostchangeAssignmentRewriter;
...
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.ReturnRewriter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.StaticInstanceCondenser;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.SynchronizedRewriter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.TryRewriter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.TypeFilter;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.UselessNops;
import org.benf.cfr.reader.bytecode.analysis.opgraph.op3rewriters.WhileRewriter;
...
public class Op03Rewriters {
    ...
    public static void replaceStackVarsWithLocals(List<Op03SimpleStatement> op03SimpleParseNodes) {
        Op03Rewriters.rewriteWith(op03SimpleParseNodes, new StackVarToLocalRewriter());
    }
